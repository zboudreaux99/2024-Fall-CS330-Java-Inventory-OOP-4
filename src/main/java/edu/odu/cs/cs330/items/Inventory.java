...
public class Inventory implements Iterable<ItemStack>
{
    ...
    {
        /**
         * A record of all attempted item store operations. Each entry is one
         * of...
         *
         *   - Stored
         *   - Discarded
         *   - Merged
         */
        private final List<String[]> updateRecord;
        ...
        public Builder withItems(final ItemStack stack)
        {
            ...
            if (match.isPresent()) {
                ...
                if (matchingStack.permitsStacking()) {
                    ...
                    updateRecord.add(new String[]{"Merged", stack.getItem().getName()});
                    return this;
                }
            }

            if (this.items.size() == this.capacity) {
                updateRecord.add(new String[]{"Discarded", stack.getItem().getName()});
                return this;
            }

            this.items.add(stack);
            updateRecord.add(new String[]{"Stored", stack.getItem().getName()});
        ...
        public Pair<List<String[]>, Inventory> build()
        {
            return new Pair<>(this.getUpdateLog(), new Inventory(this));
        }
